...
<div class="side_right">
    <form action="controller?action=create" method="POST" id="signupForm" class="">
        <div class="top_Box">${msg}</div>
        <ul>
            <li class="inline"><label >First Name*</label></li>
            <li class="inline"><input class="signup_input" placeholder="First Name" type="text" size="40" name="firstname" value="${User.firstName}" required /></li>
        </ul>
        <ul>
            <li class="inline"><label >Last Name*</label></li>
            <li class="inline"><input class="signup_input" placeholder="Last Name" type="text" size="40" name="lastname" value="${User.lastName}" required /></li>
        </ul>
        <ul>
            <li class="inline"><label >Email*</label></li>
            <li class="inline"><input class="signup_input" placeholder="Email" type="email" size="40" name="email" value="${User.email}" required /></li>
        </ul>
        <ul>
            <li class="inline"><label >Street*</label></li>
            <li class="inline"><input class="signup_input" placeholder="Street" type="text" size="40" name="street" value="${User.address.street}" required /></li>
        </ul>
        <ul>
            <li class="inline"><label >Apartment*</label></li>
            <li class="inline"><input class="signup_input" placeholder="Apartment" type="text" size="40" name="apartment" value="${User.address.apartment}" required /></li>
        </ul>
        <ul>
            <li class="inline"><label >City*</label></li>
            <li class="inline"><input class="signup_input" placeholder="City" type="text" size="40" name="city" value="${User.address.city}" required /></li>
        </ul>
        <ul>
            <li class="inline"><label >State*</label></li>
            <li class="inline"><select name="state" class="signup_input" value='${User.address.state}'>
        ...
        <ul>
            ...
            <li class="inline"><input class="signup_input" placeholder="PostalCode" type="number" size="40" name="postalCode" value="${User.address.zip}" required /></li>
        </ul>
        <ul>
            <li class="inline"><label >PhoneNumber*</label></li>
            <li class="inline"><input class="signup_input" placeholder="PhoneNumber" type="number" size="10" name="phonenumber" value="${User.phoneNumber}" required /></li>
        </ul>
        <ul>
            <li class="inline"><label >Age*</label></li>
            <li class="inline"><input class="signup_input" placeholder="Age" type="number" size="3" name="age" value="${User.age}" required /></li>
        </ul>
        <ul>
            <li class="inline"><label >VoterId (if any)</label></li>
            <li class="inline"><input class="signup_input" placeholder="VoterId" type="number" size="10" name="voterid" value="${User.voterId}" /></li>
        </ul>
        <ul>
            <li class="inline "></li>
