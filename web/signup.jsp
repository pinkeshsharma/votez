...
<form action="controller?action=create" method="POST" id="signupForm" class="signup_center">
    ...
    <ul>
        ...
        <li class="inline"><input class="signup_input" placeholder="Age" type="number" size="3" name="age" value="" required /></li>
    </ul>
    <ul>
        <li class="inline"><label >VoterId (if any)</label></li>
        <li class="inline"><input class="signup_input" placeholder="VoterId" type="number" size="10" name="voterid" value="" /></li>
    </ul>
    <ul>
